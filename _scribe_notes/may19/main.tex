...
\author{CSE 291A/DSC 291 Scribe Notes\\Instructor: Prof. Hao Zhang}
...
\node[align=center, font=\scriptsize, anchor=north] at (1.25,-0.70) {capacity\\without good\\KV mgmt.};
\node[align=center, font=\scriptsize, anchor=north] at (3.85,-0.70) {capacity\\with better\\KV mgmt.};
